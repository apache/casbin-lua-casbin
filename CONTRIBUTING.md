...
Before raising a new issue, check our [issue list](https://github.com/apache/casbin-lua-casbin/issues) to determine if it already contains the problem that you are facing.
